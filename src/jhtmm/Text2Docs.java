...
public class Text2Docs {
	...
	static CommandOption.Boolean keepSequenceBigrams = new CommandOption.Boolean(Text2Docs.class, "keep-sequence-bigrams", "[TRUE|FALSE]", false, false,
        ...
        static CommandOption.Boolean keepSentences = new CommandOption.Boolean(Text2Docs.class, "keep-sentences", "[TRUE|FALSE]", false, false,
			...
			if (keepSequenceBigrams.value) {
				...
				pipeList.add( new TokenSequence2FeatureSequence() );
                        ...
                        if(keepSentences.wasInvoked()){
                            pipeList.add(new TokenSequence2FeatureSequenceVector());
                        }
